...
npx awal@2.12.1 x402 details http://localhost:3000/api/example

# Make a paid request
npx awal@2.12.1 x402 pay http://localhost:3000/api/example
```
...
- [ ] Get wallet address with `npx awal@2.12.1 address`
...
- [ ] Test with `curl` (should get 402) and `npx awal@2.12.1 x402 pay` (should get 200)
